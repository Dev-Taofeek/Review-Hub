          ...
          <div className="hidden md:block">
            <div className="sticky top-[92px]">
              <div className="mb-4 flex items-center gap-2 px-3">
                <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[var(--primary)] shadow-sm shadow-emerald-900/20">
        ...
        <div className="mt-6 flex gap-2 overflow-x-auto pb-2 md:hidden">
          {adminNav.map((item) => (
            <a
              key={item.href}
              href={item.href}
              className="flex shrink-0 items-center gap-1.5 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-sm font-semibold text-[var(--muted)] shadow-sm transition-all hover:border-[var(--primary)] hover:text-[var(--primary)]"
            >
